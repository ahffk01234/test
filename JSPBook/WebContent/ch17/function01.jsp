				...
				<div class="content-wrapper">
					...
					<div class="row">
						...
						<div class="col-md-10 stretch-card grid-margin">
							<div class="card">
								<div class="card-body">
									<p class="card-title">function01.jsp</p>
									
									<p>java 문자열 검색</p>
									<!-- 설정된 문자열에 검색 문자열 java가 포함되어있는지 확인하도록 fn:contains 태그를 작성 -->
									<p>Hello, Java Server Page! = > ${fn:contains("Hello, Java Server Page!", "java") }</p>
									<!-- 설정된 문자열에 검색 문자열 java가 포함되어있는지 확인하도록 fn:containsIgnoreCase 태그를 작성 -->
									<!-- 대소문자를 상관하지 않고 검색한다. -->
